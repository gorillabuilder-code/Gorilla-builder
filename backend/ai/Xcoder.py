"""
Xcoder.py — gor://a AI Code Generation Engine (OpenRouter xAI Grok)
...
class XCoder:
    ...
    async def _call_provider(
        ...
        async with httpx.AsyncClient(timeout=self.timeout_s) as client:
            ...
            total_tokens = int(usage.get("total_tokens", 0))*1.2
    ...
    async def generate_code(
        ...
        for attempt in range(max_retries + 1):
            try:
                ...
                canonical["usage"] = {"total_tokens": cumulative_tokens*1.2}
