...
class Planner:
    ...
    "   - Chat/vision(strict): 'accounts/fireworks/models/qwen3-8b' or use *only :free* openrouter models with process.env OPENROUTER_API_KEY for vision (MOSTLY PREFERED OPENROUTER, but specify the model to the coder)\n"
